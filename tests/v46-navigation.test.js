...
test('navigation exposes the dedicated Company route shell and shared groups',()=>{
...
test('multiple groups can remain expanded and all groups may be collapsed',()=>{
  ...
  assert.deepEqual(N.normalizeExpandedGroups(['bogus','intelligence','company-recruitment','intelligence']),['company-recruitment','intelligence']);
...
test('Settings stays routable, old recruitment routes migrate, and Logs remains advanced-only',()=>{
