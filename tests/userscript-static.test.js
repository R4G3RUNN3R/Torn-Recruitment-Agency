...
const PINNED_RUNTIME='ae424579d7b18c4e2b04e944e7f82931fcbe1e16';
...
test('public userscript is the v4.8.0 simplified release with immutable v4.8.0 core requires',()=>{
  ...
  assert.match(boot,/EXPECTED_APP_VERSION\s*=\s*'4\.8\.0'/);
