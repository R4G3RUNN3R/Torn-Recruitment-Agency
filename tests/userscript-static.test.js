...
test('public userscript is the v4.7.4 modular bootstrap with immutable reviewed runtime requires',()=>{
...
test('v4.7.4 loads Company and Faction dependencies before the source application',()=>{
...
test('v4.7.4 preserves the direct and addEventListener click bridge',()=>{
...
test('v4.7.4 guards the shared DOM against duplicate worlds and legacy RA UI',()=>{
...
test('v4.7.4 keeps scrollable content, title-bar-only Settings and safe maximize restore',()=>{
