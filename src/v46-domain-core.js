(function (root, factory) {
  ...
  function normalizeCompanyRecruitment(record = {}, observedAt = Date.now(), options = {}) {
    ...
    const base = {
      ...
      suggestedVacancyId:text(record.suggestedVacancyId),
      evaluationSummary:record.evaluationSummary && typeof record.evaluationSummary === 'object' ? {...record.evaluationSummary} : null,
